...
const Header: React.FC<HeaderProps> = (props) => {
    return (
        <header className="fixed top-0 left-0 right-0 z-30 bg-slate-900/80 backdrop-blur-sm border-b border-slate-700/80 h-20">
            <div className="max-w-screen-2xl mx-auto px-4 lg:px-6 h-full flex items-center justify-between">
                {/* Cycles Display */}
