...
const MilestoneToast: React.FC<MilestoneToastProps> = ({ name, rewardDescription, onClose }) => {
  ...
  return (
    <div
      className="fixed top-5 left-1/2 -translate-x-1/2 z-50 w-full max-w-md p-4 bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 text-white rounded-xl shadow-2xl animate-slide-in-down"
      role="alert"
    >
